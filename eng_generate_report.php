                     ...
                     <div class="card card-navy">
                        <div class="card-header">
                           ...
                           <div class="card-tools">
                              ...
                              <a class="btn btn-sm btn-floating-action btn-default-light" href="eng_report.php" data-toggle="tooltip" data-placement="top" title="Back to Report"><i class="fas fa-file"></i></a>
                           </div>
                           <!-- /.card-tools -->
                        </div>
                        <!-- /.card-header -->
                        ...
                        <div class="row no-print">
                           <div class="col-12 card-footer m-0">
                              <a href="eng_report_print.php" target="_blank" class="btn btn-default float-right bg-navy btn-lg"><i class="fas fa-print"></i> Print</a>
                           </div>
                        </div>
                     </div>
                     <!-- /.card -->
