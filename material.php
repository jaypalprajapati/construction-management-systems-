                           ...
                           <table id="example1" class="table table-striped table-hover  table-bordered table-head-fixed text-nowrap" cellspacing="0" width="100%">
                              ...
                              <tbody>
                                 <tr>
                                    ...
                                    <td><a class="btn btn-sm btn-info" href="edit_material.php?id=<?php echo $row['m_id']; ?>"><i class="fas fa-eye"> Edit</i></a></td>
                                    <td><a class="btn btn-sm btn-primary" href="status_material.php?id=<?php echo $row['m_id']; ?>"><i class="fas fa-times"> Change</i></a></td>
                                    <td><a onClick="confirmDelete();" class="btn btn-sm btn-danger" href="delete_material.php?id=<?php echo $row['m_id']; ?>"><i class="fas fa-trash"> Delete</i></a></td>
                                 </tr>
                              </tbody>
                              <?php
                                 } 
