            ...
            <div class="sidebar">
               ...
               <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item">
                        <a href="report.php" class="nav-link active elevation-4">
                     ...
                     <div class="card card-navy">
                        ...
                        <div class="card-body">
                           <section class="content">
                              <!--  <div class="card-body"> -->
                              <div class="col-lg-12">
                                 <form class="form form-validate" novalidate="novalidate" id="report-form" method="POST" action="report_process.php">
                                    <div class="row">
                                       <div class="col-sm-12">
                        ...
                        <a href="report.php" class="btn ink-reaction btn-raised btn-lg btn-error btn-danger btn-default">
                        Cancel
                        </a>
                        </div>
                        </div>
