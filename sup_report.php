                     ...
                     <div class="card card-navy">
                        ...
                        <div class="card-body">
                           <section class="content">
                              <!--  <div class="card-body"> -->
                              <div class="col-lg-12">
                                 <form class="form form-validate" novalidate="novalidate" id="report-form" method="POST" action="sup_reportpr.php">
                        ...
                        <div class="col-md-12">
                        <div class="form-group">
                        <input type="submit" id="submit-form" value="Save" class="btn ink-reaction btn-raised btn-lg btn-primary">
                        <!--  <input type="reset" value="Reset" class="btn ink-reaction btn-raised btn-lg btn-warning"> -->
                        <a href="sup_report.php" class="btn ink-reaction btn-raised btn-lg btn-error btn-default">
                        Cancel
                        </a>
                        </div>
                        </div>
