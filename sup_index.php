<?php 
   ...
   $id=$_SESSION['id'];
         ...
         $qry1="SELECT * FROM labor WHERE isactive=1 AND labor.id=$id";
   //echo "$qry1";
   ...
   //echo "$qry1";
         ...
         if (mysqli_num_rows($rs4)>0) {
           ...
           $qry2="SELECT * FROM transaction WHERE isactive=1 AND transaction.id=$id";
   //echo "$qry1";
         ...
         <div class="sidebar">
            ...
            <nav class="mt-2">
               <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                  <li class="nav-item">
                     <a href="sup_index.php" class="nav-link active">
      ...
      <div class="content-wrapper">
         ...
         <div class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6">
                     <h1 class="m-0 text-dark">Welcome Supervisor , <?php echo $user; ?></h1>
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-6">
                  ...
                  <div class="row">
                     <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                           ...
                           <a href="sup_material.php" class="small-box-footer">Go To   <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                     </div>
                     <!-- ./col -->
                     <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                           ...
                           <a href="sup_transaction.php" class="small-box-footer">Go To <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                     </div>
                     <div class="col-lg-3 col-6">
                        <!-- small box -->
                     ...
                     <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                           ...
                           <a href="sup_labour.php" class="small-box-footer">Go To <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                     </div>
                  </div>
               </div>
