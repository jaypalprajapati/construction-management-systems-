...
<!---728x90--->
    ...
    <div class=" w3l-login-form">
        ...
        <form action="checklogin.php" method="POST"  data-parsley-validate="">
         ...
         <input class="form-control" type="email" name="email" style="background-color: white;" placeholder="Enter email" value="<?php echo $un; ?>" required data-parsley-type="email" data-parsley-trigger="change" data-parsley-error-message="* Please enter valid email" class="my"/>
