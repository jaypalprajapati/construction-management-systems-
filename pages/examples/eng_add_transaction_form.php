...
<html>
   ...
   <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed ">
      <form action="eng_addtransaction1.php" method="post" class="form form-validate" novalidate="novalidate" enctype="multipart/form-data" data-parsley-validate="">
         <!-- Site wrapper -->
         <div class="wrapper">
         <!-- Navbar -->
               ...
               <div class="row mb-2">
                  ...
                  <div class="col-sm-12">
                     <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="../../eng_transaction.php">Transaction</a></li>
                  ...
                  <div class="card card-navy">
                     <div class="card-header">
                        ...
                        <div class="card-tools">
                           ...
                           <a class="btn btn-sm btn-floating-action btn-default-light" href="../../eng_transaction.php" data-toggle="tooltip" data-placement="top" title="View Transaction"><i class="fas fa-truck-moving"></i>
                           </a>
                        </div>
                     </div>
                     <!-- /.card-header -->
                                    ...
                                    <center>
                                       <div class="col-md-12">
                                          <div class="form-group"> 
                                             ...
                                             <a href="eng_add_transaction_form.php"class="btn ink-reaction btn-raised btn-lg btn-warning">Reset</a>
                                             <a href="../../eng_transaction.php" class="btn ink-reaction btn-raised btn-lg btn-error btn-secondary btn-default">
                                             Cancel
                                             </a>
                                          </div>
                                       </div>
