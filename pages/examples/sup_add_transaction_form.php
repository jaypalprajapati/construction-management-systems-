...
<html>
   ...
   <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed ">
      <form action="sup_addtransaction1.php" method="post" class="form form-validate" novalidate="novalidate" enctype="multipart/form-data" data-parsley-validate="">
         <!-- Site wrapper -->
         <div class="wrapper">
            <!-- Navbar -->
               ...
               <div class="sidebar">
                  ...
                  <nav class="mt-2">
                     <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                           <a href="sup_add_labor_form.php" class="nav-link">
                        ...
                        <li class="nav-item">
                           <a href="sup_add_transaction_form.php" class="nav-link active elevation-4">
                           <b>  <i class="fas fa-truck-moving"></i>
                           Transaction
                           </p> </b>
                           </a>
                        </li>
                        ...
                        <div class="card card-navy">
                           <div class="card-header">
                              ...
                              <div class="card-tools">
                                 ...
                                 <a class="btn btn-sm btn-floating-action btn-default-light" href="../../sup_transaction.php" data-toggle="tooltip" data-placement="top" title="view Transaction"><i class="fas fa-truck-moving"></i></a>
                                 </a>
                              </div>
                           </div>
                           <!-- /.card-tools -->
                                          ...
                                          <center>
                                             <div class="col-md-12">
                                                <div class="form-group">
                                                   ...
                                                   <a href="sup_add_transaction_form.php"class="btn ink-reaction btn-raised btn-lg btn-warning">Reset</a>
                                                   <!--  <a href="../../sup_transaction.php" class="btn ink-reaction btn-raised btn-lg btn-error btn-secondary">
                                                      Cancel
                                                      </a> -->
                                                </div>
                                             </div>
