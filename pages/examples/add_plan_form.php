...
<html>
   ...
   <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed ">
      <form action="addplan.php" method="post" class="form form-validate" novalidate="novalidate" enctype="multipart/form-data" data-parsley-validate="">
         <!-- Site wrapper -->
         <div class="wrapper">
            <!-- Navbar -->
                     ...
                     <div class="row mb-2">
                        ...
                        <div class="col-sm-12">
                           <ol class="breadcrumb float-sm-left">
                              ...
                              <li class="breadcrumb-item"><a href="../../plan.php">Plan</a></li>
                        ...
                        <div class="card card-navy">
                           <div class="card-header">
                              ...
                              <div class="card-tools">
                                 ...
                                 <a class="btn btn-sm btn-floating-action btn-default-light" href="../../plan.php" data-toggle="tooltip" data-placement="top" title="View All plan"><i class="fab fa-product-hunt"></i>
                                 </a>
                              </div>
                           </div>
                           <!-- /.card-tools -->
                                          ...
                                          <div class="row">
                                             <div class="col-md-12">
                                                <div class="form-group"> 
                                                   ...
                                                   <a href="add_plan_form.php" class="btn ink-reaction btn-raised btn-lg btn-warning">Reset</a>
                                                   <a href="../../plan.php" class="btn ink-reaction btn-raised btn-lg btn-error btn-default">
                                                   Cancel
                                                   </a>
                                                </div>
                                             </div>
