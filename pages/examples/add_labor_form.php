...
<html>
   ...
   <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed ">
      <form action="addlabour.php" method="post" class="form form-validate" novalidate="novalidate" enctype="multipart/form-data" data-parsley-validate="">
         <!-- Site wrapper -->
         <div class="wrapper">
         <!-- Navbar -->
                  ...
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                           <li class="nav-item">
                              <a href="../../labour.php" class="nav-link active elevation-4">
               ...
               <div class="card card-navy">
                  <div class="card-header">
                     ...
                     <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="card-refresh" data-source="add_labor_form.php" data-source-selector="card-refresh-content"><a href="add_labor_form.php"><i class="fas fa-sync-alt"></i></a></button>
                        ...
                        <div class="card-body">
                           <div class="col-lg-12">
                              ...
                              <div class="form-group">
                                 <label for="inputStatus"class="required control-label" required>Project Name</label>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group"> 
                                          ...
                                          <a href="add_labor_form.php" class="btn ink-reaction btn-raised btn-lg btn-warning">Reset</a>
                                          <a href="../../labour.php" class="btn ink-reaction btn-raised btn-lg btn-error btn-default">
                                          Cancel
                                          </a>
                                       </div>
                                    </div>
