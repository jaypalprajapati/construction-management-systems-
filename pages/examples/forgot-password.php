...
<body style="background-image: url('images/bg19.jpg') !important;">
...
<!---728x90--->
    ...
    <div class=" w3l-login-form">
       <h2 style="color: ;  font-family: serif;">  <b>Forgot Password</b></h2> 
         <p style="color: white;"> You forgot your password? Here you can easily retrieve a new password.</p>
        <form action="forgotpr.php" method="post" data-parsley-validate=" ">

            <div class="form-section mb-3">

         <input class="form-control" type="email" name="email" style="background-color: white;" placeholder="Email Address" required data-parsley-type="email" data-parsley-trigger="change" data-parsley-error-message="* Please enter valid email" class="my"/>
            ...
            <button type="submit" name="btn_sb" value="">Reset my Password</button>
        </form>
