...
<html>
   ...
   <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed ">
      <form action="addcity.php" method="get" data-parsley-validate="">
         <!-- Site wrapper -->
         <div class="wrapper">
            <!-- Navbar -->
                        ...
                        <div class="card card-navy">
                           <div class="card-header">
                              ...
                              <div class="card-tools">
                                 <button type="button" class="btn btn-tool" data-card-widget="card-refresh" data-source="add_city_form.php" data-source-selector="card-refresh-content"><a href="add_city_form.php"><i class="fas fa-sync-alt"></i></a></button>
                                 <button type="button" class="btn btn-tool" data-card-widget="maximize"><i class="fas fa-expand"></i></button>
                                 <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fa fa-angle-down"></i></button>
                                 <a class="btn btn-sm btn-floating-action btn-default-light" href="../../city.php" data-toggle="tooltip" data-placement="top" title="view City"> <i class="nav-icon fas fa-city"></i>
                                 </a>
                              </div>
                           </div>
                           <!-- /.card-tools -->
                           ...
                           <div class="card-body">
                              <section class="content">
                                 <div class="form-group">
                                    <label class="required control-label" for="inputClientCompany">City Name</label>
                                    <input type="text" id="inputClientCompany" class="form-control" name="city_name" data-parsley-pattern="^[a-zA-Z]+$"required>
                                 </div>
                                 <!-- /.card-body -->
                                 <div class="row col-sm-12">
                                    <div class="col-xs-4"><input type="submit" value="submit" class="btn btn-success bg-navy"name="btn_sb"></div>
                                    <div class="col-xs-4"> <a href="add_city_form.php" class="btn ink-reaction btn-raised btn-warning">Reset</a> </div>
                                    <div class="col-xs-4"><a href="../../city.php" class="btn btn-danger btn-default swalDefaultError ">Cancel</a></div>
                                 </div>
      </form>
