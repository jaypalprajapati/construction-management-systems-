                  ...
                  <div class="card">
                     <div class="card card-navy">
                        <div class="card-header">
                           <h3 class="card-title"><i class="fa fa-plus"></i> Add New Supervisor</h3>
                           <div class="card-tools">
                              <button type="button" class="btn btn-tool" ><a href="add_supervisor_form.php"><i class="fas fa-sync-alt"></i></a></button>
                              <button type="button" class="btn btn-tool" data-card-widget="maximize"><i class="fas fa-expand"></i></button>
                              <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fa fa-angle-down"></i></button>
                              <a class="btn btn-sm btn-floating-action btn-default-light" href="add_area_form.php" data-toggle="tooltip" data-placement="top" title="Add New Area"><i class="fa fa-plus"></i><i class="fa fa-road"></i></a>
                              <a class="btn btn-sm btn-floating-action btn-default-light" href="../../supervisor.php" data-toggle="tooltip" data-placement="top" title="view All Supervisor"> <i class="nav-icon fas fa-users"></i>
                              </a>
                           </div>
                        </div>
                        <!-- /.card-tools -->
                        <!-- /.card-header -->
                        <div class="card-body">
                           <form action="process_supervisor_reg.php" method="post" enctype="multipart/form-data"data-parsley-validate="">
                              <section class="content">
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <h6 style="color: red;"> <?php echo $msg; ?>  <?php echo $msg3; ?></h6>
                                 </div>
                                 <div class="form-group ">
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <a href="add_supervisor_form.php" class="btn ink-reaction btn-raised btn-lg btn-warning">Reset</a>
                                          <a href="../../supervisor.php" class="btn ink-reaction btn-raised btn-lg btn-error btn-default">
                                          Cancel
                                          </a>
                                       </div>
                                    </div>
