...
<body style="background-image: url('images/bg23.jpg') !important;">
...
<input type="hidden" name="uid" value="<?php echo $uid; ?>">
 ...
 <input style="background-color: white;" class="form-control" type="password" name="password" placeholder="Password" data-parsley-length="[6,12]" data-parsley-trigger="change"  required data-parsley-error-message="Please enter valid password" class="my"/>
          </div>

            <div class="form-section mb-3">
         <input style="background-color: white;" class="form-control" type="password" placeholder="Confirm Password"name="cpass" data-parsley-length="[6,12]" data-parsley-trigger="change" id="repeat_new_password" required data-parsley-error-message="Please enter valid confirm password" class="my"/>

        </div>
           
            <button type="submit" name="btn_sb" value="">Reset New Password</button>

            <a style="color: white;" class=""href="login.php">#Login</a>
