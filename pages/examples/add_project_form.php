<?php 
   ...
   $qry3="SELECT * FROM user1 WHERE utype=3  AND isactive!=2";
   //echo "$qry";
...
<html>
   <head>
      ...
      <title>Constrction | Project </title>
               ...
               <div class="container-fluid">
                  ...
                  <div class="col-sm-12">
                     <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">Add_Project</li>
                     </ol>
                  </div>
               </div>
               <br><br>
                  ...
                  <div class="card card-navy">
                     <div class="card-header">
                        ...
                        <div class="card-tools">
                           <button type="button" class="btn btn-tool" data-card-widget="card-refresh" data-source="add_project_form.php" data-source-selector="card-refresh-content"><a href="add_project_form.php"><i class="fas fa-sync-alt"></i></a></button>
                           <button type="button" class="btn btn-tool" data-card-widget="maximize"><i class="fas fa-expand"></i></button>
                           <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fa fa-angle-down"></i></button>
                           <a class="btn btn-sm btn-floating-action btn-default-light" href="../../project.php" data-toggle="tooltip" data-placement="top" title="View Project"><i class="fab fa-product-hunt"></i>
                           </a>
                        </div>
                     </div>
                     <!-- /.card-tools -->
                     ...
                     <div class="card-body">
                        <section class="content">
                           <form action="addpro.php" data-parsley-validate="">
                              <div class="form-group">
                                 <label class="required control-label"for="inputName">Project Name</label>
                                 <input type="text" id="inputName" class="form-control" name="pname"data-parsley-pattern="^[a-zA-Z]+$"required>
                              </div>
                              <div class="form-group">
                                 <label for="inputDescription">Project Address</label>
                                 <textarea id="inputDescription" class="form-control" name="padd" rows="4" required="" data-parsley-trigger="keyup" data-parsley-minlength="10" data-parsley-maxlength="200" data-parsley-minlength-message="Come on! You need to enter at least a 20 character comment.." data-parsley-validation-threshold="10"></textarea>
                              </div>
                              <div class="row">
                                 <div class="col-sm-6">
                                    <div class="form-group">
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" id="inputClientCompany" name="clname" class="form-control"data-parsley-pattern="^[a-zA-Z]+$"required>
                              </div>
                              <div class="form-group floating-label">
                                 <div class="input-group">
                                    ...
                                    <div class="input-group-content">
                                       <input type="" class="form-control" name="mn" minlength="10" maxlength="10" id="mobile" required="" aria-required="true">
                                    </div>
                                 </div>
                              </div>
                              <div class="form-group">
                                 ...
                                 <select name="eid" class="form-control" >
                                    ...
                                    <?php
                                       if(mysqli_num_rows($rs3)>0)
                                       {
                                           ...
                                           {
                                          ?>
                                    <option  name="txt_name"value="<?php echo $row['id']; ?>"><?php echo $row['fname']; ?></option>
                                    <?php
                                       }
                                       }
                                       else
                              ...
                              <div class="row">
                                 <div class="col-6">
                                    <a href="../../project.php" class="btn btn-secondary btn-default">Cancel</a>
                                    <a href="add_project_form.php" class="btn ink-reaction btn-raised btn-warning">Reset</a>
                                    <input type="submit" value="Submit" name="btn_sb" class="btn bg-navy float-right">
                                 </div>
                              </div>
                           </form>
