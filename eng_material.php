            ...
            <div class="sidebar">
               ...
               <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item">
                        <a href="eng_material.php" class="nav-link active elevation-4">
                           <b>
                     ...
                     <div class="card card-navy">
                        <div class="card-header">
                           ...
                           <div class="card-tools">
                              <button type="button" class="btn btn-tool"><a href="eng_material.php"><i class="fas fa-sync-alt"></i></a></button>
