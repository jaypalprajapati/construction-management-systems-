      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <div class="content-header">
               ...
               <div class="card">
                  <form action="update_city.php" method="GET">
                     <input type="hidden" name="id" value="<?php echo $row['city_id']; ?>">
                     <div class="card card-navy">
                        <div class="card-header">
                           <h3 class="card-title">Edit City ~ <?php  echo $row['city_name']; ?></h3>
                           <div class="card-tools">
                              ...
                              <a class="btn btn-sm btn-floating-action btn-default-light" href="pages/examples/add_city_form.php" data-toggle="tooltip" data-placement="top" title="Add New city"><i class="fa fa-plus"></i> <i class="nav-icon fas fa-city"></i></a>
                              <a class="btn btn-sm btn-floating-action btn-default-light" href="city.php" data-toggle="tooltip" data-placement="top" title="view all City"> <i class="nav-icon fas fa-city"></i></a>
                           </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                           <div class="row">
                              <div class="hbox-md col-md-12">
                                 ...
                                 <div class="form-group floating-label">
                                    <label for="" class="required control-label">City Name</label>
                                    <input type="text" class="form-control" name="city_name" value="<?php echo $row['city_name']?>" required>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          <input type="submit" class="btn ink-reaction btn-raised btn-lg btn-primary" value="Update" name="btn_sb">
                                          <a href="city.php" class="btn ink-reaction btn-raised btn-lg btn-error btn-lg btn-warning">
                                          Cancel
                                          </a>
                                       </div>
                                    </div>
