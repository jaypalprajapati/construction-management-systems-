<?php
   ...
   $qry="SELECT project.*,user1.fname,city.city_name,area.area_name  FROM project INNER JOIN user1 ON project.e_id=user1.id INNER JOIN city ON project.city_name = city.city_id INNER JOIN area ON project.area_name = area.area_id WHERE project.isactive!=2 ORDER BY doi desc";
                     ...
                     <div class="card card-navy">
                        <div class="card-header">
                           ...
                           <div class="card-tools">
                              <button type="button" class="btn btn-tool" data-card-widget="card-refresh" data-source="project.php" data-source-selector="#card-refresh-content"><a href="project.php"></a><i class="fas fa-sync-alt"></i></button>
                              <button type="button" class="btn btn-tool" data-card-widget="maximize"><i class="fas fa-expand"></i></button>
                              <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fa fa-angle-down"></i></button>
                              <a class="btn btn-sm btn-floating-action btn-default-light" href="pages/examples/add_project_form.php" data-toggle="tooltip" data-placement="top" title="Add New Project">
                                 <i class="fa fa-plus ">
                                    <!-- <ion-icon src="add-circle-outline.svg"></ion-icon> -->
                                 </i>
                              </a>
                           </div>
                           <!-- /.card-tools -->
                                 ...
                                 <tr>
                                    ...
                                    <td class="project-actions text-right py-0 align-middle">
                                       <div class="btn-group btn-group-sm">
                                          <a href="view_project.php?pid=<?php echo $row['project_id']; ?>"  title="View"class="btn btn-info"><i class="fas fa-folder" title="View"></i></a>
                                          <a href="edit_project.php ?project_id=<?php echo $row['project_id']; ?>"  title="Edit"class="btn btn-success"><i class="fas fa-eye" title="Edit"></i></a>
                                          <?php
                                             $ia=$row['isactive'];
                                             ...
                                             if ($ia==1) {
                                               # code...
                                             ?>
                                          <a href="status_project.php ?project_id=<?php echo $row['project_id']; ?>" title="Change" class="btn btn-warning"><i class="fab fa-product-hunt"  title="change"></i></a>
                                          <?php
                                             }
                                             else
                                             {
                                             ...
                                             ?>
                                          <a href="status_project.php ?project_id=<?php echo $row['project_id']; ?>" title="Change" class="btn btn-warning"><i class="fas fa-ban"  title="change"></i></a>
                                          <?php
                                             }
                                             ?>
                                          <a href="delete_project.php ?project_id=<?php echo $row['project_id']; ?>" title="Delete" class="btn btn-danger"><i class="fas fa-trash" title="Delete"></i></a>
                                       </div>
                                    </td>
                                    <td>
