...
<html>
   ...
   <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed ">
      <form action="sup_addactivity.php" method="post" data-parsley-validate="">
      <!-- Site wrapper -->
      <div class="wrapper">
         <!-- Navbar -->
                  ...
                  <div class="card card-navy">
                     <div class="card-header">
                        ...
                        <div class="card-tools">
                           ...
                           <a class="btn btn-sm btn-floating-action btn-default-light" href="sup_activity.php" data-toggle="tooltip" data-placement="top" title="view Daily Activity"> <i class="fas fa-tachometer-alt"></i>
                           </a>
                        </div>
                     </div>
                     <div class="card-body">
                        <section class="content">
                           ...
                           <div class="row">
                              <div class="col-12">
                                 <a href="sup_activity.php" class="btn btn-secondary btn-lg">Cancel</a>
