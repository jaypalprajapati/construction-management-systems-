<?php 
   require'dbconnect.php';
      ...
      $user=$_SESSION['fn'];
        ...
        $qry1="SELECT * FROM user1 WHERE isactive=1 AND utype=3";
   //echo "$qry1";
        ...
        if (mysqli_num_rows($rs1)>0) {
           ...
           $qry4="SELECT * FROM user1 WHERE isactive=1 AND utype=4";
   //echo "$qry1";
   ...
   //echo "$qry1";
        ...
        if (mysqli_num_rows($rs2)>0) {
           ...
           while ($row2=mysqli_fetch_assoc($rs2)) {
            ...
            $qry3="SELECT * FROM project WHERE isactive=1";
   //echo "$qry1";
   ...
   <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
         ...
         <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item ">
               <a href="pages/examples/lockscreen.php" class="nav-link user-image img-circle elevation-4" title="Lock Screen" style="color: black;" ><i class="fa fa-fw fa-lock"></i></a>
            </li>
            <li>
    <?php require'side.php'; ?>
      ...
      <aside class="main-sidebar sidebar-dark-light bg-navy elevation-2">
         ...
         <img src="dist/img/IMG_5 copy.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"style="opacity: .8 filter: brightness(1);">
      ...
      <div class="content-wrapper">
         ...
         <div class="content-header">
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6">
                     <h1 class="m-0 text-dark">Welcome Admin , <?php echo $user; ?></h1>
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-6">
                     ...
                     <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                           ...
                           <div class="icon">
                              ...
                              <i class="icon fa fa-cubes fa-5x"></i>
                           </div>
                           <a href="project.php" class="small-box-footer">Go To   <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                     </div>
                     <!-- ./col -->
                     <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                           ...
                           <div class="icon">
                              ...
                              <!-- <i class="icon fas fa-truck-monster"></i> -->
                           </div>
                           <a href="transaction.php" class="small-box-footer">Go To <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                     </div>
                     <div class="col-lg-3 col-6">
                        <!-- small box -->
                        <div class="small-box bg-danger">
                           ...
                           <a href="supervisor.php" class="small-box-footer">Go To <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                     </div>
                     <!-- ./col -->
                     <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                           ...
                           <a href="engineer.php" class="small-box-footer">Go To <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                     </div>
                  </div>
               </div>
