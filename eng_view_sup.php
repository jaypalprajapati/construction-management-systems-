...
<html>
   ...
   <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed ">
                  ...
                  <div class="card card-navy">
                     <div class="card-header">
                        ...
                        <div class="card-tools">
                           ...
                           <a class="btn btn-sm btn-floating-action btn-default-light" href="eng_supervisor.php" data-toggle="tooltip" data-placement="top" title="View All Superviosr"><i class="nav-icon fas fa-users"></i></a>
                        </div>
                     </div>
      ...
      <footer class="main-footer text-center">
         <strong style="color:black;">Copyright &copy; 2020-2025 <a href="eng_index.php">Construction</a>.</strong> <strong style="color:black;">All rights reserved.</strong>
