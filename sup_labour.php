<?php
   require'dbconnect.php';
    session_start();
   $id=$_SESSION['id'];
   $qry="SELECT labor.*,project.project_name,user1.fname FROM labor INNER JOIN project ON labor.project_id = project.project_id INNER JOIN user1 ON labor.id = user1.id WHERE labor.isactive!=2 AND labor.id=$id ORDER BY doi desc";
   //echo "$qry";
            ...
            <div class="sidebar">
               ...
               <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item">
                        <a href="pages/examples/sup_add_labor_form.php" class="nav-link active elevation-4">
                     ...
                     <div class="card card-navy">
                        <div class="card-header">
                           ...
                           <div class="card-tools">
                              ...
                              <a href="sup_labour.php"></a><i class="fas fa-sync-alt"></i></button>
                              <button type="button" class="btn btn-tool" data-card-widget="maximize"><i class="fas fa-expand"></i></button>
                              <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fa fa-angle-down"></i></button>
                              <a class="btn btn-sm btn-floating-action btn-default-light" href="pages/examples/sup_add_labor_form.php" data-toggle="tooltip" data-placement="top" title="Add New Labour"><i class="fa fa-plus">  <i class="fas fa-people-carry"></i></i></a>
                           </div>
                           <!-- /.card-tools -->
                        </div>
                        <!-- /.card-header -->
