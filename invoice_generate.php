                  ...
                  <div class="card">
                     <div class="card card-navy">
                        <div class="card-header">
                           ...
                           <div class="card-tools">
                              <button type="button" class="btn btn-tool"><a href="generate_report.php"><i class="fas fa-sync-alt"></i></a></button>
                              <button type="button" class="btn btn-tool" data-card-widget="maximize"><i class="fas fa-expand"></i></button>
                              <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fa fa-angle-down"></i></button>
                              <a class="btn btn-sm btn-floating-action btn-default-light" href="invoice.php" data-toggle="tooltip" data-placement="top" title="Back to Invoice"> <i class="nav-icon fas fa-file"></i></a>
                           </div>
                           <!-- /.card-tools -->
                        </div>
                        <!-- /.card-header -->
                           ...
                           <table id="example1" class="table table-striped table-hover  table-bordered table-head-fixed text-nowrap" cellspacing="0" width="100%">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td><a href="transection/<?php echo $row['material_image']; ?>"><img class="img elevation-2" style="height:70px;width:100px" src="transection/<?php echo $row['material_image']; ?>"></a></td>
                                 </tr>
                                 <?php
                                    }
                                    }
                     ...
                     <div class="row no-print">
                        <div class="col-12 card-footer m-0">
                           <a href="invoice_print.php" target="_blank" class="btn btn-default float-right bg-navy btn-lg"><i class="fas fa-print"></i> Print</a>
                        </div>
                     </div>
                     <!-- /.card -->
                  </div>
