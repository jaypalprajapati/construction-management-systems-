<?php
   ...
   //echo "$qry1";
       ...
       if (mysqli_num_rows($rs4)>0) {
         ...
         $qry2="SELECT * FROM transaction WHERE transaction.id=$id AND isactive=1";
   //echo "$qry1";
         ...
         <div class="sidebar">
            ...
            <nav class="mt-2">
               <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                  <li class="nav-item">
                     <a href="eng_index.php" class="nav-link active elevation-4">
                        <b>
               ...
               <div class="row mb-2">
                  <div class="col-sm-6">
                     <h1 class="m-0 text-dark">
                        <div class="col-sm-12">
                           <h1 class="m-0 text-dark">Welcome Engineer , <?php echo $user; ?></h1>
                        </div>
                     </h1>
                  </div>
                  <!-- /.col -->
                  ...
                  <div class="row">
                     <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                           ...
                           <a href="eng_material.php" class="small-box-footer">Go To   <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                     </div>
                     <!-- ./col -->
                     <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                           ...
                           <a href="eng_transaction.php" class="small-box-footer">Go To <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                     </div>
                     <div class="col-lg-3 col-6">
                        <!-- small box -->
                        <div class="small-box bg-danger">
                           ...
                           <a href="eng_supervisor.php" class="small-box-footer">Go To <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                     </div>
                     <!-- ./col -->
                     <div class="col-lg-3 col-6">
