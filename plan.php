<?php
   require'dbconnect.php';
       // $qry="SELECT * FROM plan WHERE isactive!=2";
    $qry="SELECT plan.*,project.project_name FROM plan INNER JOIN project ON plan.projectid = project.project_id WHERE plan.isactive!=2 ORDER BY doi desc";
                  ...
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                           ...
                           <li class="nav-item">
                              <a href="Plan.php" class="nav-link active elevation-4">
                                 <!-- <i class="far fa-circle nav-icon"></i> -->
                                 <b>
                                    <i class="fab fa-product-hunt"></i>
                                    <p>
                  ...
                  <div class="card">
                     <div class="card card-navy">
                        <div class="card-header">
                           <h3 class="card-title">List Of Project plan</h3>
                           <div class="card-tools">
                              <button type="button" class="btn btn-tool"><a href="plan.php"></a><i class="fas fa-sync-alt"></i></button>
                              <button type="button" class="btn btn-tool" data-card-widget="maximize"><i class="fas fa-expand"></i></button>
                              <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fa fa-angle-down"></i></button>
                              <a class="btn btn-sm btn-floating-action btn-default-light" href="pages/examples/add_plan_form.php" data-toggle="tooltip" data-placement="top" title="Add New Plan"><i class="fa fa-plus"></i></a>
                           </div>
                        </div>
                           ...
                           <table id="myTable" class="table table-striped table-hover  table-bordered table-head-fixed text-nowrap" cellspacing="0" width="100%">
                              ...
                              <tbody>
                                 <tr>
                                    ...
                                    <td><a class="btn  btn-sm btn-primary" href="status_plan.php?id=<?php echo $row['plan_id']; ?>"><i class="fas fa-times"> Change</i></a></td>
                                    <td><a class="btn  btn-sm btn-danger" href="delete_plan.php?id=<?php echo $row['plan_id']; ?>"><i class="fas fa-trash"> Delete</i></a></td>
                                 </tr>
                              </tbody>
                              <?php
                                 }
