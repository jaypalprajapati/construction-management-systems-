...
function validateForm() {
  ...
  <link rel="stylesheet" href="dist/css/adminlte.min.css">
    ...
    <ul class="navbar-nav ml-auto">
     ...
     <li class="nav-item ">
        <a href="pages/examples/lockscreen.php" class="nav-link dot" title="Lock Screen" ><i class="fa fa-fw fa-lock" style=""></i></a>
      </li>
    </ul>
                            ...
                            <div class="card">
                                ...
                                <div class="card card-warning">
                                    ...
                                    <div class="card-body table-responsive p-0" style="height: 340px;">
                                        <table id="myTable" class="table table-striped table-hover  table-bordered table-head-fixed text-nowrap" cellspacing="0" width="100%"><br>
                                           <thead>
                                                <tr class="header">
                                                    <!-- <th >id</th> -->
