      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <div class="content-header">
               ...
               <div class="card">
                  <form action="update_material.php" method="GET">
                     <input type="hidden" name="id" value="<?php echo $id; ?>">
                     <div class="card card-navy">
                        <div class="card-header">
                           <h3 class="card-title">Edit Material ~ <?php echo $row['m_name']?></h3>
                           <div class="card-tools">
                              ...
                              <a class="btn btn-sm btn-floating-action btn-default-light" href="pages/examples/add_material_form.php" data-toggle="tooltip" data-placement="top" title="Add New Material"><i class="fa fa-plus"></i><i class="fas  fa-cubes"></i></a>
                           </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                           <div class="row">
                              <div class="hbox-md col-md-12">
                                 ...
                                 <div class="form-group floating-label">
                                    <label for="" class="required control-label">Material   Name</label>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <a href="material.php" class="btn ink-reaction btn-raised btn-lg btn-error btn-lg btn-warning">
                                          Cancel
                                          </a>
                                       </div>
                                    </div>
