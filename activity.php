                     ...
                     <div class="card card-navy">
                        <div class="card-header">
                           ...
                           <div class="card-tools">
                              ...
                              <a class="btn btn-sm btn-floating-action btn-default-light" href="add_activity_form.php" data-toggle="tooltip" data-placement="top" title="Add New Report"><i class="fa fa-plus"></i></a>
                           </div>
                           <!-- /.card-tools -->
                        </div>
                           ...
                           <table id="myTable" class="table table-striped table-hover  table-bordered table-head-fixed text-nowrap" cellspacing="0" width="100%">
                              ...
                              <tbody>
                                 <tr>
                                    ...
                                    <td><a class="btn btn-info" href="edit_activity.php?id=<?php echo $row['activity_id']; ?>"><i class="fas fa-eye"> Edit</i></a></td>
                                 </tr>
                              </tbody>
                              <?php
                                 }
