...
<html>
   <head>
      ...
      <title>Construction | Labour</title>
                     ...
                     <div class="card card-navy">
                        <div class="card-header">
                           ...
                           <div class="card-tools">
                              ...
                              <a href="labour.php"><i class="fas fa-sync-alt"></i></a></button>
                              <button type="button" class="btn btn-tool" data-card-widget="maximize"><i class="fas fa-expand"></i></button>
                              <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fa fa-angle-down"></i></button>
                              <a class="btn btn-sm btn-floating-action btn-default-light" href="pages/examples/add_labor_form.php" data-toggle="tooltip" data-placement="top" title="Add New Labour"><i class="fa fa-plus"></i></a>
                           </div>
                           <!-- /.card-tools -->
                        </div>
                        <!-- /.card-header -->
                           ...
                           <table id="example1" class="table table-striped table-hover  table-bordered table-head-fixed text-nowrap" cellspacing="0" width="100%">
                              ...
                              <tbody>
                                 <tr>
                                    ...
                                    <td><a class="btn btn-info" href="edit_labor.php ?id=<?php echo $row['l_id']; ?>"><i class="fas fa-eye"> Edit</i></a></td>
                                    <td><a class="btn btn-danger" href="delete_labor.php ?id=<?php echo $row['l_id']; ?>"><i class="fas fa-trash"> Delete</i></a></td>
                                    <!-- <td>
                                       <?php echo $row['doi']?>
                                       </td> -->
                                 </tr>
