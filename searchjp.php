...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#viewdata").click(function(e) {                
              ...
              $.ajax({    //create an ajax request to load_page.php
                type: "GET",
                url: "listsearchjp.php",             
                data:$("#search_form").serialize(), // "coun_id="+id, {}
                                       ...
                                       <thead>
                                                <tr class="header">
                                                   <!--  <th>id</th> -->
                                                    ...
                                                    <!-- <div class="col-3"> <input type="text" placeholder="Search for names.." title="Type in a name" ></div> --> 
                                                   <!--  <div class="col-3"> </div>  -->
                                                   <div class="row">
                                                     <form id="search_form">
    ...
    <div class="input-group-append">
      <button class="btn btn-secondary" id="viewdata" type="submit">
