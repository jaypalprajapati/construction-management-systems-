...
<html>
   <head>
      ...
      <title> Construction |Edit profile</title>
            ...
            <div class="sidebar">
               ...
               <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item">
                        <a href="profile.php" class="nav-link active elevation-4">
         ...
         <div class="content-wrapper">
            ...
            <div class="content-header">
               ...
               <div class="card">
                  <div class="card card-outline card-navy">
                     <div class="card-header">
                        <h3 class="card-title"><b>Edit  ~ <?php echo $row['fname']?></b></h3>
                     ...
                     <!-- /.card-header -->
                     <div class="card-body">
                        <form class="form form-validate" action="update_profile.php" novalidate="novalidate" id="edit-engineer-form" method="get">
                           <!-- <div class="hbox-column col-md-12"> -->
                           <section class="content">
                              <input type="hidden" name="id" value="<?php echo $id; ?>">
                              <div class="form-group">
                                 <label for="" class="required control-label"> Name</label>
