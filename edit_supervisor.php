            ...
            <div class="content-header">
                  ...
                  <div class="row mb-12">
                     ...
                     <div class="col-sm-12">
                        <ol class="breadcrumb float-sm-left">
                           ...
                           <li class="breadcrumb-item"><a href="superviosr.php">superviosr</a></li>
                  ...
                  <div class="card card-navy">
                     <div class="card-header">
                        ...
                        <div class="card-tools">
                           ...
                           <a class="btn btn-sm btn-floating-action btn-default-light" href="pages/examples/add_supervisor_form.php" data-toggle="tooltip" data-placement="top" title="Add New superviosr"><i class="fa fa-plus"></i> <i class="nav-icon fas fa-users"></i></a>
                           ...
                           <a class="btn btn-sm btn-floating-action btn-default-light" href="superviosr.php" data-toggle="tooltip" data-placement="top" title="View All Supervisor"> <i class="nav-icon fas fa-users"></i></a>
                        </div>
                     </div>
                     <!-- /.card-header -->
                     <div class="card-body">
               ...
               <div class="card">
                  <div class="card card-outline card-navy">
                     ...
                     <div class="card-body">
                        <form action="update6.php" method="post" enctype="multipart/form-data">
                           <div class="row">
                              <div class="col-sm-4">
