            ...
            <div class="sidebar">
               ...
               <nav class="mt-2">
                  <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                     ...
                     <li class="nav-item">
                        <a href="pages/examples/sup_add_transaction_form.php" class="nav-link active elevation-4">
                           <b>
                     ...
                     <div class="card card-navy">
                        <div class="card-header">
                           ...
                           <div class="card-tools">
                              ...
                              <a class="btn btn-sm btn-floating-action btn-default-light" href="pages/examples/sup_add_transaction_form.php" data-toggle="tooltip" data-placement="top" title="Add New Transaction"><i class="fa fa-plus"></i><i class="fas fa-truck-moving"></i></a>
                           </div>
                           <!-- /.card-tools -->
                        </div>
                        <!-- /.card-header -->
                              ...
                              <table id="example1" class="table table-striped table-hover  table-bordered table-head-fixed text-nowrap" cellspacing="0" width="100%">
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td>
                                          <a href="transection/<?php echo $row['material_image']; ?>" data-toggle="lightbox" data-title=" <?php echo $row['project_name']?> /- <?php echo $row['m_name']?>">
                                          <img class="img elevation-2 w3-hover-opacity img-fluid mb-2"  style="width:20px;cursor:pointer"onclick="onClick(this)"alt="white sample"/ src="transection/<?php echo $row['material_image']; ?>"></a>
                                       </td>
                                    </tr>
                                 </tbody>
                                 <?php
