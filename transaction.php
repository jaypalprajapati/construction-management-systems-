...
<html>
   <head>
      ...
      <title>Construction | Transection</title>
                                 ...
                                 <table id="example1" class="table table-striped table-hover  table-bordered table-head-fixed text-nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td>
                                             <a href="transection/<?php echo $row['material_image']; ?>" data-toggle="lightbox" data-title=" <?php echo $row['project_name']?> /- <?php echo $row['m_name']?>"> View BIll</a> / <a href="downlod.php?file=<?php echo $row['material_image']; ?>">Download</a>
                                             <!--  <img class="img elevation-2 w3-hover-opacity img-fluid mb-2"  style="width:30%;cursor:pointer"onclick="onClick(this)"alt="white sample"/ src="transection/<?php echo $row['material_image']; ?>"> -->
                                          </td>
                                          <td>
                                             <?php echo $row['remark']?>
                                          </td>
