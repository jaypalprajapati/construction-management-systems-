<?php 
   ...
   //  $rs1=mysqli_query($conn,$qry1);
      ...
      // $qry="SELECT user1.*,city.city_name,area.area_name FROM user1 INNER JOIN city ON user1.city_name = city.city_id INNER JOIN area ON user1.area_name = area.area_id  WHERE user1.isactive!=2 AND  user1.utype=3";
       ...
       $qry1= "SELECT * FROM user1 WHERE utype=4 LIMIT ".$this_page_first_result.','.$no_rec_pp ;
                     ...
                     <div class="card card-navy">
                        <div class="card-header">
                           ...
                           <div class="card-tools">
                              <button type="button" class="btn btn-tool" data-card-widget="card-refresh" data-source="supervisor.php" data-source-selector="#card-refresh-content"><i class="fas fa-sync-alt"></i></button>
                              <button type="button" class="btn btn-tool" data-card-widget="maximize"><i class="fas fa-expand"></i></button>
                              <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fa fa-angle-down"></i></button>
                              <a class="btn btn-sm btn-floating-action btn-default-light" href="pages/examples/add_supervisor_form.php" data-toggle="tooltip" data-placement="top" title="Add New Supervisor"><i class="fa fa-plus"></i></a>
                           </div>
                           <!-- /.card-tools -->
                        </div>
                        <!-- /.card-header -->
                                 ...
                                 <tr>
                                    ...
                                    <td class="project-actions text-right py-0 align-middle">
                                       <div class="btn-group btn-group-sm">
                                          <a href="view_sup.php?id=<?php echo $row['id']; ?>"  title="View"class="btn btn-info"><i class="fas fa-eye" title="View"></i></a> <!-- fa-folder -->
                                          <a href="edit_supervisor.php?id=<?php echo $row['id']; ?>"  title="Edit"class="btn btn-success">
                                          ...
                                          <?php
                                             ...
                                             if ($ia==1) {
                                               # code...
                                             ?>
                                          <a href="status_supervisor.php?id=<?php echo $row['id']; ?>" title="change" class="btn btn-warning"><i class="" title="change"></i><i class="fas fa-user"></i></a>
                                          <?php
                                             }
                                             else
                                             {
                                             ...
                                             ?>
                                          <a href="status_supervisor.php?id=<?php echo $row['id']; ?>" title="change" class="btn btn-warning"><i class="" title="change"></i><i class="fas fa-ban"></i></a>
                                          <?php
                                             }
                                             ?>
                                          <a href="delete_supervisor.php?id=<?php echo $row['id']; ?>" title="Delete" class="btn btn-danger"><i class="fas fa-trash" title="Delete"></i></a>
                                       </div>
                                    </td>
                                    <td>
                        ...
                        <nav aria-label="Page navigation">
                           <ul class="pagination pagination-sm m-0 float-right">
                              <li class="page-item">
                                 <?php if ($pageno>1) {
                                    # code...
                                    echo '<a class="page-link fa fa-angle-double-left" href="supervisor.php?pageno='.$no3.'">    
                                    </a>'; } ?>
                              </li>
                              <?php  
                              ...
                              <li class="page-item ">
                                 <?php
                                    # code...
                                    echo '<a class="page-link" href="supervisor.php?pageno='.$pageno.'">
                                    '.$pageno.'
                                    </a>' ?>
                              </li>
                              <?php
                              ...
                              <li class="page-item">
                                 <?php if ($no2<=$total_pages) {
                                    # code...
                                    echo '<a class="page-link fa fa-angle-double-right" href="supervisor.php?pageno='.$no2.'">
                                    </a>'; } ?>
                              </li>
                           </ul>
                        </nav>
